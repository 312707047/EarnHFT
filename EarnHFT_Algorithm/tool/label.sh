...
nohup python tool/slice_model.py --data_path /mnt/sda1/novis/Projects/EarnHFT/data_preprocess/preprocess/merge/ETHUSDT/2023-08-10-2023-08-12/valid.feather \
    >log/data/split_valid/ETHUSDT.log 2>&1 &
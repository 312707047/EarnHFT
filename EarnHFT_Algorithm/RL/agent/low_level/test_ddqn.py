...
class trader(object):
    def __init__(self,args) -> None:
        ...
        self.input_dim=len(np.load("/mnt/sda1/novis/Projects/EarnHFT/data_preprocess/ic_analysis/feature_analysis/ETHUSDT/2023-08-10_2023-08-12/second_feature.npy",allow_pickle=True))
